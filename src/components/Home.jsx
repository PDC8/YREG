    ...
    return (
        <div>
            ...
            <div className="justify-around mb-16 flex overflow-x-auto">
                ...
                <p className="text-lg text-gray-700 w-[500px] max-h-">
            ...
            <div className="mb-16 flex overflow-x-auto">
                <img 
                src="https://placecats.com/millie/300/150" 
                className="min-w-[400px] min-h-[200px] w-96 h-auto object-cover mb-8">
                </img>
                <h2 className="text-4xl font-bold text-nowrap mb-6">What <br /> We Do</h2>
